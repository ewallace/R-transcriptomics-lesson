...
<img src="img/r-starting-how-it-should-look-like.png" title="How it should look like at the beginning of this lesson" alt="How it should look like at the beginning of this lesson" width="100%" style="display: block; margin: auto;" />
...
<img src="img/kitten-try-things.jpg" title="plot of chunk kitten-img" alt="plot of chunk kitten-img" width="400px" style="display: block; margin: auto;" />
...
[1] knitr_1.20    remotes_2.0.2

loaded via a namespace (and not attached):
 [1] Rcpp_1.0.0              digest_0.6.18          
 [3] magrittr_1.5            evaluate_0.12          
 [5] highr_0.7               rlang_0.3.4            
 [7] stringi_1.2.4           curl_3.2               
 [9] rmarkdown_1.11          tools_3.4.4            
[11] stringr_1.3.1           requirements_0.0.0.9000
[13] yaml_2.2.0              compiler_3.4.4         
[15] htmltools_0.3.6        
~~~
{: .output}
